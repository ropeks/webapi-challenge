...
A: Express router and express middleware.
- [ ] Describe Middleware?
A: Middleware is a piece of software allows us to add additional 
functionality to the code.
- [ ] Describe a Resource?
A: Resource is an element on which CRUD ops are performed.
- [ ] What can the API return to help clients know if a request was successful?
A: API can return JSON response that can contain message for the user.
- [ ] How can we partition our application into sub-applications?
A: By using express router.
## Project Setup
